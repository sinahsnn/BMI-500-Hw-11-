...
[For checking the Full results please check] (Hassannia_BMI500HW11.pdf)
...
** Note: Chatgpt has been used for some parts of this homework. to be more clear, Part A.i, A.iii I used to model the problem. for part A.ii I used this for chcking. For part B, I did not use ChatGPT but I checked the codes with that. for part C I used OSET codes so there is not required to use GPT but as I want to implement similar code and just replace the functions I used chatGPT in this part.  
